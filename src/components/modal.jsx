          ...
          <div className="z-50 bg-white p-4 rounded-lg shadow-md relative">
            ...
            <div className="bg-[#393A3B] rounded-md p-6 mt-3">
              ...
              <form>
                ...
                <div className=" w-[100%] h-[50px] text-[18px] cursor-pointer rounded-md font-bold mx-auto bg-black hover:border-[#15A7AD] border text-white flex justify-center items-center mt-12">
                  <button
