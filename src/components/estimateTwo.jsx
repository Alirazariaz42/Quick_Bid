    ...
    <>
      <div className="lg:w-[80%] w-full mx-auto mt-3 p-3">
        ...
        <div className="mt-12">
            ...
            <div onClick={openModal} className="bg-[#15A7AD] mb-8 rounded-lg w-[180px] h-[60px] mx-auto flex justify-center items-center cursor-pointer mt-8">
