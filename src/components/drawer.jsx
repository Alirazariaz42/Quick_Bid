                    ...
                    >
                      <div className="flex justify-start gap-1 cursor-pointer">
                        ...
                        <svg
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          class="w-4 h-4 text-white mt-[29px]"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      <button onClick={openModal} className="mt-[18px] w-[149px] h-[42px] bg-white hover:bg-[#15A7AD] font-inter text-[16px] text-black rounded-[15px]">
                        Get Estimate
                      </button>
                    </div>
                  </div>
