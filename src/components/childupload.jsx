...
function Childupload({ closeModal }) {
              ...
              <form>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 container mx-auto">
                  ...
                  <div className="col-span-1">
                    ...
                    <div className="border-b border-gray-300 bg-[#15A7AD]">
                      <input
                        id="file-upload"
                        type="file"
                ...
                <div className=" w-[30%] h-[50px] text-[18px] cursor-pointer rounded-md font-bold mx-auto bg-black hover:border-[#15A7AD] border text-white flex justify-center items-center mt-12">
                  <button
